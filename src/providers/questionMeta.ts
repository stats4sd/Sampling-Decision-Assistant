export default
    [
        ...
        // case proportions
        {
            ...
            "type": "range",
            "selectOptions": "",
            "label": "Roughly what value for this proportion do you expect to find with this survey? If you have no idea whatsoever set it as 50%, otherwise provide your best estimate.",
            "section": "Indicators",
