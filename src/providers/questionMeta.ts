export default
    [
        ...
        { "isQuestion": "TRUE", "controlName": "q5.3.1", "type": "select", "selectOptions": "Yes, No", "label": "Is there a single list of all sampling units at this stage from where you can select them?", "section": "Selecting the sampling units", "condition": "", "labelMultiple": null },
        { "isQuestion": "TRUE", "controlName": "q5.3.2", "type": "select", "selectOptions": "Yes, No", "label": "Can a list be obtained from elsewhere?", "section": "Selecting the sampling units", "condition": "", "labelMultiple": null },
        { "isQuestion": "TRUE", "controlName": "q5.3.3", "type": "select", "selectOptions": "Area based sampling, WASH clusters, Key informant lists, Community build frames\nArea based sampling", "label": "Is any of these options a sensible way forward to replace the sampling frame for the sampling units?", "section": "Selecting the sampling units", "condition": "", "labelMultiple": null },
        { "isQuestion": "TRUE", "controlName": "q5.3.4", "type": "select", "selectOptions": "Yes, No", "label": "Is this list (sampling frame) up-to-date?", "section": "Selecting the sampling units", "condition": "", "labelMultiple": null },
        { "isQuestion": "TRUE", "controlName": "q5.3.5", "type": "select", "selectOptions": "Yes, No", "label": "Are there any exclusions or omissions that you are aware of?", "section": "Selecting the sampling units", "condition": "", "labelMultiple": null },
        { "isQuestion": "TRUE", "controlName": "q5.3.6", "type": "select", "selectOptions": "Yes, No", "label": "if yes, what are the biases that may be introduced by it?", "section": "Selecting the sampling units", "condition": "", "labelMultiple": null },
        { "isQuestion": "FALSE", "controlName": "l5.4", "type": "label", "selectOptions": "", "label": "You said that the information needs to be disaggregated by {{q4.2}}. Consider whether the sampling units at this stage need to be separated into strata according to the reporting criteria", "section": "Selecting the sampling units", "condition": "type:value, controlName:q4.1, value:Disaggregated estimates", "labelMultiple": null },
        { "isQuestion": "TRUE", "controlName": "q5.4", "type": "repeat", "selectOptions": "q4.2", "label": "Show the list of possible reporting levels to and for each allow the selection of the level as a criteria for stratification. Roguhtly as follows", "section": "Selecting the sampling units", "condition": "type:value, controlName:q4.1, value:Disaggregated estimates", "labelMultiple": null },
